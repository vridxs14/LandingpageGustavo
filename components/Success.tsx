        ...
        <div className="min-h-screen bg-brand-dark flex flex-col items-center justify-center p-4 md:p-8 animate-fade-in relative overflow-hidden">
            ...
            <div className="max-w-3xl w-full bg-zinc-900/80 backdrop-blur-md border border-white/10 rounded-2xl p-8 md:p-12 relative z-10 shadow-2xl">
                ...
                <div className="space-y-6">
                    ...
                    {/* Step 3: Info */}
                    <div className="bg-black/40 border border-white/5 rounded-xl p-6 flex items-start gap-4">
                        <MessageCircle className="text-brand-green shrink-0 mt-1" size={24} />
                        <div>
                            <h3 className="text-lg font-bold text-white mb-1">Suporte via WhatsApp</h3>
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-block mt-3 text-brand-green font-bold text-sm hover:underline"
                            >
